package com.demo.example.OS.recorder;
                    ...
                    while (true) {
                        if (StreamAudioRecorder.this.mIsRecording.get()) {
                            if (this.mAudioFormat != 2) {
                                int read = this.mAudioRecord.read(this.mByteBuffer, 0, this.mByteBufferSize);
                                if (read <= 0) {
                                    onError(read);
                                    break;
                                }
                                ...
                                int read2 = this.mAudioRecord.read(this.mShortBuffer, 0, this.mShortBufferSize);
                                if (read2 <= 0) {
                                    onError(read2);
                                    break;
                                }
